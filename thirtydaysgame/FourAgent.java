 ...
 */
public class FourAgent extends ThirtyDaysThirtyCampaignsAgent {

  public FourAgent(String host, int port) {
    super(host, port);
  }
  ...
  public static void main(String[] args) {
	  FourAgent agent = new FourAgent("localhost", 9898);
    agent.connect("agent4");
  }
