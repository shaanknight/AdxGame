 ...
 */
public class TwentytwoAgent extends ThirtyDaysThirtyCampaignsAgent {

  public TwentytwoAgent(String host, int port) {
    super(host, port);
  }
  ...
  public static void main(String[] args) {
	  TwentytwoAgent agent = new TwentytwoAgent("localhost", 9898);
    agent.connect("agent22");
  }
